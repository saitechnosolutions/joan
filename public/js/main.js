...
$("body").imagesLoaded(function () {
	$("#loader3").fadeOut();
	$("#loader-overflow").delay(100).fadeOut(100);
});
			...
			$prevArrow =
				$arrows === true ?
					$options.prevArrow ?
						...
						'"></i></span>' :
						'<button class="tty-slick-text-btn tty-slick-text-prev"><i class="icon-arrows-left"></i></span>' :
					'',
			$nextArrow =
				$arrows === true ?
					$options.nextArrow ?
						...
						'"></i></span>' :
						'<button class="tty-slick-text-btn tty-slick-text-next"><i class="icon-arrows-right"></i></span>' :
					'',
