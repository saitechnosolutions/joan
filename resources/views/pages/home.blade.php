...
<body>
    ...
    <div id="wrap" class="boxed ">
        <div class="grey-bg"> <!-- Grey BG  -->
            ...
            <div class="slider-area page-section" id="index-link">
                ...
                <div class="quicky-element-carousel home-slider arrow-style"
                                ...
                                <div class="col-lg-12">
                                    <div class="inner-slide parallelbg1">
                                        ...
                                        <div class="slider-img">
                                            <img src="/images/ai.webp" alt="Slider Product">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="inner-slide parallelbg2">
                                        ...
                                        <div class="slider-img">
                                            <img src="/images/cloud.svg" alt="Slider Product">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="inner-slide parallelbg3">
                                        ...
                                        <div class="slider-img">
                                            <img src="/images/data2.svg" alt="Slider Product">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="inner-slide parallelbg4">
                                        ...
                                        <div class="slider-img">
                                            <img src="/images/cyber.svg" alt="Slider Product">
                                ...
                                <div class="col-lg-12">
                                    <div class="inner-slide">
                                        <div class="slide-content">
                                            ...
                                            <div class="slide-btn">
                                                <a class="quicky-btn horizontal-line_ltr"
                                                    href="shop-left-sidebar.html">Discover Now!</a>
                                            </div>
                                        </div>
                                        <div class="slider-img">
                                            <img src="/images/2.png" alt="Slider Product">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="slide-item animation-style-03 bg-1">
                        <div class="slider-progress"></div>
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="inner-slide">
                                        <div class="slider-img">
                                            <img src="/images/3.png" alt="Slider Product">
                                        </div>
                                        <div class="slide-content slide-content_right">
                                            ...
                                            <p class="short-desc">Produce and supply various Handicraft items all over
                                                the world which were very attractive</p>
                                            <div class="slide-btn">
                                                <a class="quicky-btn horizontal-line_ltr horizontal-line_rtl"
                                                    href="shop-left-sidebar.html">Discover Now!</a>
                                            </div>
                                        </div>
                                    </div>
    ...
    <!-- OUR TEAM -->
    {{-- <div id="team_sec" class="page-section biege-bg pt-100-cont">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="mb-40">
                        <h2 class="section-title">OUR <span class="bold">MEMBERS</span></h2>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12 text-center wow fadeInUp" data-wow-duration="1s">
                    <img src="joan/ourteam.jpg" alt="img">
                </div>
            </div>
        </div>
    </div> --}}
